...
-file("/home/travis/.kerl/builds/19.3/otp_src_19.3/bootstrap/lib/parsetools/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
-dialyzer({nowarn_function, 'yeccgoto_\'<Component>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<Ident>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<UnionVal>\''/7}).
'yeccgoto_\'<UnionVal>\''(45, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_52(52, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, 'yeccgoto_\'<bool>\''/7}).
'yeccgoto_\'<bool>\''(0=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_12(_S, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, 'yeccgoto_\'<bool_and>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<bool_compare>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<bool_or>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<constraint>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<expr_in>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<expr_twiddle>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<factor>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<factor_not>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<term>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<toplevel>\''/7}).
