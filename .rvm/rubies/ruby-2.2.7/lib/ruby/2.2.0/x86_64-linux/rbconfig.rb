...
module RbConfig
  RUBY_VERSION.start_with?("2.2.7"[/^[0-9]+[.][0-9]+[.]/]) or
    raise "ruby lib version (2.2.7) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "2"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "470"
  CONFIG["INSTALL"] = "/usr/bin/install"
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/travis/.rvm/rubies/ruby-2.2.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/.rvm/rubies/ruby-2.2.7' '--without-tcl' '--without-tk' '--without-gmp' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.2.7"
