-module(icparse).
-file("/home/travis/.kerl/builds/19.3/otp_src_19.3/lib/ic/src/icyeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%% 
...
-dialyzer({nowarn_function, 'yeccgoto_\'<add_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<and_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<any_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<array_declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<attr_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<base_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<boolean_literal>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<boolean_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<case>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<case_label>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<char_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<complex_declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<const_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<const_exp>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<const_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<constr_forward_decl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<constr_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<context_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<declarators>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<element_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<enum_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<enumerator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<except_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<export>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<fixed_array_size>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<fixed_pt_const_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<fixed_pt_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<floating_pt_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<forward_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<inheritance_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<integer_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<interface>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<interface_body>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<interface_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<interface_header>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<member>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<member_list>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<module>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<mult_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<octet_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<op_attribute>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<op_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<op_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<or_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<param_attribute>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<param_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<param_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<parameter_dcls>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<positive_int_const>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<primary_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<raises_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<scoped_name>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<sequence_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<shift_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<signed_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<signed_long_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<signed_short_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<simple_declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<simple_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<specification>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<string_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<struct_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<switch_body>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<switch_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<template_type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<type_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<type_declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<type_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<unary_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<unary_operator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<union_type>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<unsigned_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<unsigned_long_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<unsigned_short_int>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'<xor_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OE_pragma\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OE_preproc\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OorM_<case>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OorM_<case_label>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OorM_<definition>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OorM_<fixed_array_size>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'OorM_<member>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Opt_<context_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Opt_<inheritance_spec>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Opt_<op_attribute>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Opt_<raises_expr>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Opt_readonly\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'Ugly_pragmas\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<enumerator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<export>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<integer_literal>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<member>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<param_dcl>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<scoped_name>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<simple_declarator>\''/7}).
...
-dialyzer({nowarn_function, 'yeccgoto_\'ZorM_<string_literal>\''/7}).
